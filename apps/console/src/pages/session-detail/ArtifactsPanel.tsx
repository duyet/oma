              ...
              >
                <div className="flex items-start gap-1.5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {a.declared && (
                      <div className="text-[10px] font-medium text-fg-subtle mt-0.5">
                        ★ Declared output
                      </div>
                    )}
          ...
          <>
            <DialogHeader>
              ...
              <p className="text-[11px] text-fg-subtle">
                ...
                {artifact.declared ? " · ★ Declared output" : ""}
                {artifact.isError ? " · tool error" : ""}
              </p>
              {artifact.description && (
                <p className="text-[11px] text-fg-muted line-clamp-2">{artifact.description}</p>
              )}
            </DialogHeader>
