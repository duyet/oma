...
describe("<ArtifactsPanel />", () => {
  ...
  it("badges declared outputs from agent.output_declared", async () => {
    server.use(
      http.get("/v1/sessions/sess_decl/outputs", () =>
    ...
    expect(screen.getByText("★ Declared output")).toBeInTheDocument();
    await userEvent.click(screen.getByRole("button", { name: "List view" }));
    expect(screen.getByText(/Weekly metrics digest/)).toBeInTheDocument();
  });
