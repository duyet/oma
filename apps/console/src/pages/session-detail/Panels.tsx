 ...
 *
 * `ResourcePanel` fetches and JSON-dumps an agent / environment / vault.
 * Only the vault badge routes here now — agent + environment badges open
 * the richer `SessionInspector` tabs instead, and the former `FilesPanel`
 * became the Inspector's Files tab.
 */
