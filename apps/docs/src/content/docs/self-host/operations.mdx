...
git pull
pnpm install
npx wrangler d1 migrations apply oma-auth         --remote --config apps/main/wrangler.local.jsonc
npx wrangler d1 migrations apply oma-integrations --remote --config apps/main/wrangler.local.jsonc
...
```bash
npx wrangler secret list -c apps/integrations/wrangler.local.jsonc
```
