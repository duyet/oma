...
export const SYSTEM_PROVIDERS: SystemProviderDescriptor[] = [
  {
    ...
    envKeys: [],
    factoryPath: "@getoma/sandbox-sdk/adapters/local-subprocess",
    cfCompatible: false,
  ...
  },
  {
    ...
    factoryPath: "@getoma/sandbox-sdk/adapters/litebox",
    cfCompatible: false,
  ...
  },
  {
    ...
    factoryPath: "@getoma/sandbox-sdk/adapters/boxrun",
    cfCompatible: true,
    capabilities: ["exec", "files", "pause_resume"],
  },
  {
    ...
    factoryPath: "@getoma/sandbox-sdk/adapters/daytona",
    cfCompatible: true,
    capabilities: ["exec", "files", "pause_resume"],
  },
  {
    ...
    factoryPath: "@getoma/sandbox-sdk/adapters/e2b",
    cfCompatible: true,
    capabilities: ["exec", "files", "pause_resume"],
  },
  {
    ...
    factoryPath: "@getoma/sandbox-sdk/adapters/kubernetes",
    cfCompatible: false,
    capabilities: ["exec", "files", "pause_resume"],
  },
  {
    ...
    factoryPath: "@getoma/sandbox-sdk/adapters/k8s-bridge",
    cfCompatible: true,
    capabilities: ["exec", "files", "pause_resume"],
  },
  {
    ...
    factoryPath: "@getoma/sandbox-sdk/adapters/kubernetes-remote",
    cfCompatible: true,
    capabilities: ["exec", "files", "pause_resume"],
  },
  {
  ...
  },
  {
    ...
    factoryPath: "@getoma/sandbox-sdk/adapters/docker-compose",
    cfCompatible: false,
    capabilities: ["exec", "files"],
  },
  {
    ...
    factoryPath: "@getoma/sandbox-sdk/adapters/github-actions",
    cfCompatible: true,
    capabilities: ["exec", "files"],
  },
  {
    ...
    factoryPath: "@getoma/sandbox-sdk/adapters/remote-agent",
    cfCompatible: true,
    capabilities: ["exec", "files", "pause_resume"],
  },
  {
    ...
    factoryPath: "@getoma/sandbox-sdk/adapters/openshell",
    cfCompatible: true,
    capabilities: ["exec", "files"],
  },
  {
  ...
  },
  {
    ...
    envKeys: [],
    factoryPath: "@getoma/sandbox-sdk/adapters/browser-vm",
    cfCompatible: true,
    capabilities: ["exec", "files"],
  },
];
