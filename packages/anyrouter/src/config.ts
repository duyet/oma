 ...
 * when the request goes to AnyRouter so that alias never leaves OMA.
 */
 ...
 * no Anthropic BYOK, so that alias 404s `model_unavailable`.
 * `anyrouter/free` is the live non-BYOK catalog id. Never emit the dotted
 * 4.6 slug.
 */
