...
export default defineConfig({
  ...
  resolve: {
    ...
    alias: [
      ...
      { find: "@getoma/sandbox-sdk/orchestrator", replacement: "./packages/sandbox-sdk/src/orchestrator.ts" },
      { find: "@getoma/sandbox-sdk/adapters/local-subprocess", replacement: "./packages/sandbox-sdk/src/adapters/local-subprocess.ts" },
      { find: "@getoma/sandbox-sdk/adapters/litebox", replacement: "./packages/sandbox-sdk/src/adapters/litebox.ts" },
      { find: "@getoma/sandbox-sdk/adapters/daytona", replacement: "./packages/sandbox-sdk/src/adapters/daytona.ts" },
      { find: "@getoma/sandbox-sdk/adapters/e2b", replacement: "./packages/sandbox-sdk/src/adapters/e2b.ts" },
      { find: "@getoma/sandbox-sdk/adapters/boxrun", replacement: "./packages/sandbox-sdk/src/adapters/boxrun.ts" },
      { find: "@getoma/sandbox-sdk/adapters/dynamic-workers", replacement: "./packages/sandbox-sdk/src/adapters/dynamic-workers.ts" },
      { find: "@getoma/sandbox-sdk/adapters/kubernetes", replacement: "./packages/sandbox-sdk/src/adapters/kubernetes.ts" },
      { find: "@getoma/sandbox-sdk/adapters/k8s-bridge", replacement: "./packages/sandbox-sdk/src/adapters/k8s-bridge.ts" },
      { find: "@getoma/sandbox-sdk/adapters/browser-vm", replacement: "./packages/sandbox-sdk/src/adapters/browser-vm.ts" },
      { find: "@getoma/sandbox-sdk/adapters/kubernetes-remote", replacement: "./packages/sandbox-sdk/src/adapters/kubernetes-remote.ts" },
      { find: "@getoma/sandbox-sdk/adapters/docker-compose", replacement: "./packages/sandbox-sdk/src/adapters/docker-compose.ts" },
      { find: "@getoma/sandbox-sdk/adapters/github-actions", replacement: "./packages/sandbox-sdk/src/adapters/github-actions.ts" },
      { find: "@getoma/sandbox-sdk/adapters/remote-agent", replacement: "./packages/sandbox-sdk/src/adapters/remote-agent.ts" },
      { find: "@getoma/sandbox-sdk/adapters/openshell-policy", replacement: "./packages/sandbox-sdk/src/adapters/openshell-policy.ts" },
      { find: "@getoma/sandbox-sdk", replacement: "./packages/sandbox-sdk/src/index.ts" },
  ...
  test: {
    ...
    exclude: [
      ...
      // (pnpm --filter @getoma/sandbox-sdk test).
      "packages/sandbox-sdk/test/openshell-probe.test.ts",
    ],
